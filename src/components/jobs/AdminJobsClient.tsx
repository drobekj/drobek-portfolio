...
export default function AdminJobsClient({ jobs, positionsCount }: Props) {
...
className={`w-[92px] shrink-0 rounded px-3 py-2 text-center text-sm font-semibold text-black transition-colors ${              selectedIds.size > 0
